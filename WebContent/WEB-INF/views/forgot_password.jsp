...
<html lang="en">
  <head>
    ...
    <title>NMT FORGOT PASSWORD</title>
...
<div>
  <div class="modal-header">
	<h3>NMT BICYCLE : Forgot Password</h3>
  </div>
  <script type="text/javascript">
  	function set_link(){
  		var code = document.getElementById("code_change").value;
  		
  		document.getElementById("myForm").action = "reset_password.htm?code_change="+code;
  	}
  </script>
  <div class="modal-body">
	<form class="form-horizontal loginFrm" action="reset_password.htm" id="myForm" onsubmit="set_link()" method="post">
	  <c:if test="${email_send != null }">
		...
		<input type="text" id="email" placeholder="email" name="email"
			 pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
              ...
              value="${email_send }"/ readonly="readonly">
	  	</div>
	  	<label><strong>CODE CHANGE</strong></label>
        <input type="text" id="code_change" placeholder="code change" name="code_change"/>
        <p style="color: blue;">We have sent the code change to your email</p>
        <p><strong>${mess_change }</strong> </p>
        <a href="forgot_password.htm"><strong>Re-enter email</strong> </a><br>
      </c:if>
      <c:if test="${email_send == null }">
      	<div class="control-group">		
	  	<label><strong>YOUR EMAIL</strong></label>						
