...
<div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
  ...
  <div class="modal-body">
	<form class="form-horizontal loginFrm" action="test.htm?url_present=about_us" method="post">
	  ...
	  <div class="control-group">
        ...
        <br>
        <a href="forgot_password.htm"><strong>Forgot password</strong> </a><br>
	  </div>
