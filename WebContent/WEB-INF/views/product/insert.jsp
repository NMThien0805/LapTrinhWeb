...
<body>
	<form name="myForm" onsubmit="return validateForm()" action="http://localhost:8080/Web/product/insert.htm" modelAttribute="data_product" method="post">
		${message}
		<div>
			<label>brands</label>
			<input type="text" name="product.brands"/>
		</div>
		<div>
			<label>itemname</label>
			<input type="text" name="product.itemname"/>
		</div>
		<div>
			<label>color</label>
		...
		<div>
			...
			<input type="text" name="product.newproduct"/>
		</div>
		<div>
			<label>itemfullname1</label>
			<input type="text" name="product_bonus.fullname1"/>
			<label>itemfullname2</label>
			<input type="text" name="product_bonus.fullname2"/>
		</div>
		<div>
			<label>description1</label>
			<input type="text" name="product_bonus.description1"/>
			<label>description2</label>
			<input type="text" name="product_bonus.description2"/>
			<label>description3</label>
			<input type="text" name="product_bonus.description3"/>
			<label>description4</label>
			<input type="text" name="product_bonus.description4"/>
			<label>description5</label>
			<input type="text" name="product_bonus.description5"/>
		</div>
		<div>
			<label>reviews</label>
			<input type="text" name="product.reviews"/>
		</div>
		<div>
			<label>type</label>
		...
		<div>
			...
			<input type="text" name="count_text"/>
			<label>count link</label>
			<input type="text" name="count_link"/>
		</div>
		<div>
			<button class="btn btn-default">Insert</button>
		</div>
	</form>
	<a href="http://localhost:8080/Web/product/index_product.htm">Quay lại trang chủ</a>
</body>
</html>